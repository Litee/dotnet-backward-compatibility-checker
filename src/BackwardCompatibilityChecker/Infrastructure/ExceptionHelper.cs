...
namespace BackwardCompatibilityChecker.Infrastructure
{
    /// <summary>
    ...
    public static class ExceptionHelper
    {
        ...
        /// </returns>
        static public bool IsFatal(Exception ex)
        {
        ...
        /// </returns>
        static public bool IsSecurityOrFatal(Exception ex)
        {
            if (!(ex is SecurityException))
            {
                return ExceptionHelper.IsFatal(ex);
            }
            return true;
        }
        ...
        /// </summary>
        /// <example>Take different actions in a finally block depending if an exception was thrown or not.
        /// <code>
        ...
        /// </code>
        /// </example>
        /// <remarks>More information about the technical details can be found at http://geekswithblogs.net/akraus1/archive/2008/04/08/121121.aspx </remarks>
