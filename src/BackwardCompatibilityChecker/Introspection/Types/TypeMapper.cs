...
namespace BackwardCompatibilityChecker.Introspection.Types
{
    ...
    {
        static Dictionary<string, string> mySimpleType2FullType = new Dictionary<string, string>
        {
            {"bool", "System.Boolean"},
            {"byte", "System.Byte"},
            {"sbyte", "System.SByte"},
        ...
        static Dictionary<string, string> myFullType2SimpleType = new Dictionary<string, string>
        {
            {"System.Boolean", "bool"},
            {"System.Byte", "byte"},
            {"System.SByte", "sbyte"},
